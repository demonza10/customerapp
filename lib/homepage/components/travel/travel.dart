...
List<Mocksup> mocksup = const <Mocksup>[
  const Mocksup(
      title: 'หาดภูเก็ต', rating: '4.5', imageAssets: 'assets/img/travel1.jpg'),
  const Mocksup(
      title: 'วัด', rating: '3.5', imageAssets: 'assets/img/travel2.2.jpg'),
  const Mocksup(
      title: 'รีสอร์ท', rating: '2.0', imageAssets: 'assets/img/travel3.jpg'),
];
